...
public class HoldingTransactionsRepository {
    ...
    public void insertTransaction(int holdingId, LocalDate dateOfPortfolio, int quantity, 
    		BigDecimal marketValue, BigDecimal netAsset, String createdBy) {
        ...
        jdbcTemplate.update(sql, holdingId, dateOfPortfolio, quantity, 
                          marketValue, netAsset, createdBy, createdBy);
    }
